...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('loader.css') }}" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Parisienne&family=Pacifico&family=Dancing+Script&family=Great+Vibes&family=Kaushan+Script&display=swap" rel="stylesheet">
    <script>
      window.appConfig = {
        APP_URL: '{{ env("APP_URL") }}',
      };
